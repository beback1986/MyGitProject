...
int flist_add(struct flist *fl, char *filename);//impl
...
//int dstack_cflist_pushback(struct dstack *ds, char *filename); //impl
int dstack_cflist_add(struct dstack *ds, char *filename); //impl
